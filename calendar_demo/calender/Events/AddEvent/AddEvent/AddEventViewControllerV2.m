#import "AddEventViewControllerV2.h"
...
@interface AddEventViewControllerV2 ()<UINavigationControllerDelegate,
                                     ...
                                     AddEventNavigationBarDelegate,
                                     UploadImageDelegate,
                                     ATMHudDelegate,
                                     AddEventTimesViewDelegate,
                                     UITextFieldDelegate>
{
    AddEventNavigationBar *navBar;
...
@implementation AddEventViewControllerV2
...
- (void)viewDidLoad
{
    ...
    scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, topImageView.frame.size.height, 320, [DeviceInfo fullScreenHeight] - topImageView.frame.size.height)];
...
- (void)initImagePickerView
{
    ...
    [txtFieldTitle setText:eventTitle];
