...
{
    NSArray* nibView =  [[NSBundle mainBundle] loadNibNamed:@"AEOptionentry" owner:self options:nil];
    AEOptionentry * view = (AEOptionentry*)[nibView objectAtIndex:0];
